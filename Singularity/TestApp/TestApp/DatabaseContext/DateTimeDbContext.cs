...
namespace TestApp.DatabaseContext 
{
    public  class DateTimeDbContext : DbContext
    {
        ...
        public virtual DbSet<CurrentTime> CurrentTime { get; set; } = null!;
...
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CurrentTime>(entity =>
            {
                ...
                entity.Property(e => e.CurrentTimeValue)
                    .HasColumnType("datetime")
                    .HasColumnName("CurrentTimeValue");
            });
